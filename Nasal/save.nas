...
var resume_state = func {
    ...
    var running = getprop("/save/running");
    setprop("/engines/active-engine/running", running);
    ...
    var starter = getprop("/save/starter");
    setprop("/controls/switches/starter", starter);
